...
export class Token extends Entity {
  ...
  set memberNumber(value: string | null) {
    if (!value) {
      this.unset("memberNumber");
    } else {
      this.set("memberNumber", Value.fromString(<string>value));
    }
  }
  ...
  set membership(value: string | null) {
    if (!value) {
      this.unset("membership");
    } else {
      this.set("membership", Value.fromString(<string>value));
    }
  }
